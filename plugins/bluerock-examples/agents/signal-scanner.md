---
name: signal-scanner
description: Finds recent signals on a target company for an Account Research run — hiring, funding, product launches, news, leadership moves — each timestamped and sourced. Part of the Account Research team; usually dispatched by /bluerock:research after the researcher. Use when you need the "what's new" on a company.
