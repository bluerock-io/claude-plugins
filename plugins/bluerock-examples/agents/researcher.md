---
name: researcher
description: Builds the company profile for an Account Research run — what they do, stage and funding, size, product, and who's who — from public web sources, with citations. Part of the Account Research team; usually dispatched by /bluerock:research. Use when you need a sourced profile of a target company.
