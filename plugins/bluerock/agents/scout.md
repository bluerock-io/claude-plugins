...
usable scorecard in a couple of minutes. Bound yourself to **3 to 5 good fetches** and stop.
...
2. **Scan, briefly.** Answer only these, one or two lines each:
   ...
   - **Size and stage:** public/private, rough headcount, last funding if it's easy to find.
...
- `WebSearch` for the company site and recent coverage; `WebFetch` the two or three pages
