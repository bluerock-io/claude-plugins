...
plugin behind [BlueRock for AI Builders](https://learn.bluerock.io) — the run-as-is core
...
> **New here?** The [BlueRock for AI Builders learning path](https://learn.bluerock.io) sets
